...
import numpy as np
import torch
from .models import build_ACT_model, build_CNNMLP_model, build_TactileACT_model, build_ACTNormals_model
...
def build_ACTNormals_model_and_optimizer(args_override):
    parser = argparse.ArgumentParser('DETR training and evaluation script', parents=[get_args_parser()])
    args = parser.parse_args()
    ...
    model = build_ACTNormals_model(args)
    model.cuda()
