...
def main():
    ...
    ckpt_dir = f'/scr/gnq/train_logs/{expr_name}' if os.getlogin() == 'gnq' else f'./ckpts/{expr_name}'
    dataset_dir = '/scr/gnq/compressed_datasets/aloha_mobile_fork/' if os.getlogin() == 'gnq' else '/home/gnq/data/aloha_mobile_fork/'
    #########################################################
