...
from sleep_plus import sleep_all_robots,sleep_puppet_robots
...
def opening_ceremony(master_bot_left, master_bot_right, puppet_bot_left, puppet_bot_right):
    ...
    # input("Enter to robot_reboot_motors")
...
def on_press(key):
    ...
    try:
        ...
        #     user_input = 'C'
        if key == Key.enter:  # 检测是否按下了 Enter 键
            user_input = 'Enter'  # 设置 user_input 为 'Enter'
...
if __name__ == '__main__':
    ...
    while current_episode <= args['end_idx']:
        ...
        print("*" * 100)
        print("Press 'Enter' to continue to the next episode, 'R' to repeat this episode, 'Q' to quit:")
