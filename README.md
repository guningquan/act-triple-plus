...
## Note
1. Although we primarily use a ResNet-based tactile encoder in our experiments, the codebase also supports a U-Net variant. Readers are encouraged to experiment with this alternative by modifying lines 391–394 in detr_vae.py.
